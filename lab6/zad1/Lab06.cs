...
public static class CliqueGraphExtender
    ...
    /// </remarks>
    public static int CliqueNumber(this IGraph g, out int[] clique)
        {
    ...
    public static bool IsIzomorpchic(this IGraph g, IGraph h, out int[] map)
        {
        map=null;
    ...
    private sealed class IzomorpchismHelper
        ...
        /// <param name="g">Pierwszy badany graf</param>
        /// <param name="h">Drugi badany graf</param>
        internal IzomorpchismHelper(IGraph g, IGraph h)
            {
            this.g=g;
            this.h=h;
