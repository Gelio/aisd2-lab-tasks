...
class Lab06
    ...
    private static IGraph[] cliq_test;
    private static IGraph[,] izo_test;
    ...
    public static void PrepareTests()
        ...
        cliq_test = new IGraph[6];
        izo_test = new IGraph[4,2];
        ...
        cliq_test[5]=rgg.UndirectedGraph(typeof(AdjacencyListsGraph),5000,0.001); 
        ...
        izo_test[2,1] = new AdjacencyListsGraph(izo_test[2,0]);
        izo_test[2,1] = rgg.Permute(izo_test[2,1]);

        izo_test[3,0] = rgg.UndirectedGraph(typeof(AdjacencyListsGraph),15,0.01,1,3);
    ...
    public static bool CliqueTest(IGraph g, int cn, int[] cl)
        {
