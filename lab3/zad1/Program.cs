...
class Test
{
    ...
    public static void Main()
    {
        ...
        g2[2] = rgg.DAG(typeof(AdjacencyListsGraph<SimpleAdjacencyList>), 1000, 0.2, 1, 1);
        ...
        g3[2] = rgg.DirectedGraph(typeof(AdjacencyListsGraph<SimpleAdjacencyList>), 1000, 0.2, 1, 1);
    ...
    static bool TopologicalSortTest(Graph g, int[] ord)
    {
