...
namespace asd2_lab11
{
    ...
    class MinNumberTest : Test
    {
        int expected_result;
        int expected_cost;
        public MinNumberTest(int myNum, Graph g, int result, int cost) : base(myNum, g)
        {
            expected_cost = cost;
    ...
    class MinCostTest : Test
    {
        int[] costs;
        int expected_cost;
        public MinCostTest(int myNum, Graph g, int[] costs, int cost) : base(myNum, g)
        {
            expected_cost = cost;
            this.costs = costs;
        }
    ...
    class Program
    {
        ...
        {
            Graph g0 = new AdjacencyListsGraph<HashTableAdjacencyList>(true, 9);
            g0.AddEdge(0, 1, 25);
            g0.AddEdge(1, 4, 25);
            g0.AddEdge(4, 5, 25);
            g0.AddEdge(5, 7, 10);
            ...
            Graph g1 = new AdjacencyListsGraph<HashTableAdjacencyList>(true, 8);
            g1.AddEdge(0, 1, 5);
            g1.AddEdge(1, 2, 5);
            g1.AddEdge(1, 3, 5);
            g1.AddEdge(4, 6, 5);
            ...
            Graph g2 = new AdjacencyListsGraph<HashTableAdjacencyList>(true, 4);
            g2.AddEdge(0, 1, 100);
            g2.AddEdge(2, 1, 10);
            g2.AddEdge(2, 3, 100);
            ...
            int a = 5;
            int b = 12;
            Graph g3 = new AdjacencyListsGraph<HashTableAdjacencyList>(true, a * b);
            for (int i = 0; i < b - 1; i++)
                for (int j = 0; j < a; j++)
                    for (int k = 0; k < a; k++)
            ...
            int n = 60;
            Graph g4 = new AdjacencyListsGraph<HashTableAdjacencyList>(true, n);
            for (int i = 0; i < n; i++)
                for (int j = i + 1; j < n; j++)
                    if (rand.Next(10) == 0)
